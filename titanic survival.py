...
test_data=pd.read_csv('titanic survival test.csv',encoding = "iso-8859-15")
train_data=pd.read_csv('titanic survival train.csv',encoding = "iso-8859-15")
...
def get_combined_data():
    train = pd.read_csv('titanic survival train.csv')
    test = pd.read_csv('titanic survival test.csv')
...
def recover_train_test_target():
    global combined
    train0 = pd.read_csv('titanic survival train.csv')
...
aux = pd.read_csv('titanic survival test.csv')
